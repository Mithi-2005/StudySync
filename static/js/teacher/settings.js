  ...
  // document.addEventListener("DOMContentLoaded", function () {
    var buttons = {
      ...
      var allSections = document.querySelectorAll(".formt-container");
...
//});
  ...
  //document.getElementById('toggle-new-password').addEventListener('change', function() {
    const passwordInput = document.getElementById('new_password');
    passwordInput.type = this.checked ? 'text' : 'password';
  //});

 // Toggle visibility for Current Password
 // document.getElementById('toggle-current-password').addEventListener('change', function() {
